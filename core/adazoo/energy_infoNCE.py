...
def forward_and_adapt(x, prototypes, energy_model, optimizer, replay_buffer, sgld_steps, sgld_lr, sgld_std, reinit_freq,
    ...
    energy_change_rate = calculate_change_rate(entropy_loss_history)
